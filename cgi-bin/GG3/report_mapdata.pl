...
# OK externaldb - T3/Wheat
        &print_element(
               ...
               qq{
                   select
                    concat("https://triticeaetoolbox.org/wheat/display_phenotype.php?trial_code=",accession) as url,
...
# OK externaldb - T3/Barley
        &print_element(
               ...
               qq{
                   select
                    concat("https://triticeaetoolbox.org/barley/display_phenotype.php?trial_code=",accession) as url,
                    concat (name,": ",accession) as description
                   from mapdataexternaldb
                   where mapdataid = $id
                     and name = 'T3/Barley'
...
# OK externaldb - T3/Oat
        &print_element(
               ...
               qq{
                   select
                    concat("https://triticeaetoolbox.org/oat/display_phenotype.php?trial_code=",accession) as url,                   
            concat (name,": ",accession) as description
                   from mapdataexternaldb
                   where mapdataid = $id
                     and name = 'T3/Oat'
