...
if ($cgi->param) {
    ...
    # prevent users from inserting '<script>" into queries to run XSS attacks
    if($in{'sql'} =~ /<script/ig){
        my $url="https://wheat.pw.usda.gov";
...
print qq~
<p>This page allows you to perform raw SQL queries directly.  This is the
...
sub printform {
	...
	print "<tr>\n";
	print "<td><b>Premade Queries: </b></td><td colspan=\"2\">";
    ...
    print "<td valign=\"top\"><b>SQL query:&nbsp;</b></td>";
