...
our $cmapserver = "http://wheat.pw.usda.gov/cgi-bin/cmap";	#NL 29Oct2004
our $gbrowseserver = "http://wheat.pw.usda.gov/cgi-bin/gbrowse";	#NL 29Oct2004
our $cgisyspath = "/data/cgi-bin/GG2";
our $cgiurlpath = "/cgi-bin/GG2";
our $dbimagepath = "/dbs_images/graingenes";
our $webimagepath = "/graingenes/images";
our $html_include_basepath = '/data/htdocs/GG2/templates';
...
<head>
    ...
    else {print "<title>GrainGenes 2.0</title>\n";}
    open(FILE,$file) or return 0;
    print while (<FILE>);
    close(FILE);
    return 1;
